...
import libDefault6 from "timers";
...
var RSS_URL = "http://japan-backrooms-sandbox.wikidot.com/feed/pages/pagename/draft-list/category/draft%2Csharedpage/tags/-_category-b%2C_criticism-in/order/created_at+desc/limit/10/t/%E6%89%B9%E8%A9%95%E9%96%8B%E5%A7%8B%E4%B8%8B%E6%9B%B8%E3%81%8D";
var app_default = {
  async fetch(request, env2, ctx) {
    await this.scheduled(null, env2, ctx);
    return new Response("Cron \u51E6\u7406\u3092\u624B\u52D5\u5B9F\u884C\u3057\u307E\u3057\u305F\u3002Discord \u3092\u78BA\u8A8D\u3057\u3066\u304F\u3060\u3055\u3044\u3002");
  },
  // Cron Trigger から呼び出されるハンドラ
  async scheduled(event, env2, ctx) {
    const DISCORD_WEBHOOK_URL = env2.DISCORD_WEBHOOK_URL;
    try {
      const oldHistoryRaw = await env2.BR_JP_HISTORY.get("previous_urls");
...
> **\u30EA\u30F3\u30AF:** ${item.link}`
      ...
      await env2.BR_JP_HISTORY.put("previous_urls", JSON.stringify(currentUrls));
